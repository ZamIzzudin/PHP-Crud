  ...
  <body>
    ...
    <header>
        <div class="jumbotron jumbotron-fluid position-relative mx-auto">
            ...
            <div class="container bg-primary eternal-logo">
    ...
    <main class="container mt-5 pt-5">
        ...
        <div class="row mt-5">
            <div class="card bg-dark text-light mx-auto" style="width: 18rem;">
                <img src="./src/pict/venom_poster.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title overflow-hidden">Venom : Let there be carnage</h5>
